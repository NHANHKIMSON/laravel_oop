<x-layout title="About | Page">
    ...
    <section class="bg-gray-50 dark:bg-gray-900">
        <div class="flex flex-col items-center justify-center px-6 py-12 mx-auto md:h-screen">
            <div class="w-full bg-white rounded-xl shadow-md dark:bg-gray-800 dark:border dark:border-gray-700 sm:max-w-md p-6">
                ...
                <form action="/job" method="POST" class="space-y-5">
                    @csrf
                    {{-- Job Title --}}
                    <div>
